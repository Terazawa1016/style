        ...
        <nav class="header-menu">
          <ul class="header-list" id="menu">
            <li><a href=""><i class="jobs fas fa-bars"></i></a>
                 <ul>
                   <li>
                     <form id="form4" action="{{route('age')}}" method="get">
...
<div class="nav-inner">
      <ul class="left">
          <li>
            <a href="/age?age=10">~10代</a>
          </li>
          /
          <li>
            <a href="/age?age=20">20代</a>
          </li>
          /
          <li>
            <a href="/age?age=30">30代</a>
          </li>
          /
          <li>
            <a href="/age?age=40">40代</a>
          </li>
          /
          <li>
            <a href="/age?age=50">50代</a>
          </li>
          /
          <li>
            <a href="/age?age=60">60代~</a>
          </li>
      </ul>
  </div>
{{--ヘッダーバーここまで------------------------------------------------------}}
