        ...
        <nav class="header-menu">
          <ul class="header-list" id="menu">
            <li><a href=""><i class="jobs fas fa-bars"></i></a>
                 <ul>
                   <li>
                     <form id="form4" action="{{route('height')}}" method="get">
...
<div class="nav-inner">
      <ul class="left">
          <li>
            <a href="/height?height=150">~150cm</a>
          </li>
          /
          <li>
            <a href="/height?height=160">~160cm</a>
          </li>
          /
          <li>
            <a href="/height?height=170">~170cm</a>
          </li>
          /
          <li>
            <a href="/height?height=180">~180cm</a>
          </li>
          /
          <li>
            <a href="/height?height=200">~200cm</a>
          </li>
          /
          <li>
            <a href="/height?height=tole">2m以上</a>
          </li>
      </ul>
  </div>
{{--ヘッダーバーここまで------------------------------------------------------}}
